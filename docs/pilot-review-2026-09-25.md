...
| Production switch | Incomplete diagnosis. Production checks require hardware custody and other prerequisites. Changing a flag cannot establish those guarantees. |
...
4. Deploy and verify the required hardware custody and attestation-bound key release. Moving to a GPU provider alone does not prove this property.
